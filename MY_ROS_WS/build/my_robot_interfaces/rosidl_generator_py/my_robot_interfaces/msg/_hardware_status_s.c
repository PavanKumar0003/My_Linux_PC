...
bool my_robot_interfaces__msg__hardware_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // temparature
    PyObject * field = PyObject_GetAttrString(_pymsg, "temparature");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->temparature = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // motorstatus
    PyObject * field = PyObject_GetAttrString(_pymsg, "motorstatus");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->motorstatus = (Py_True == field);
    Py_DECREF(field);
  }
  {  // errmessage
    PyObject * field = PyObject_GetAttrString(_pymsg, "errmessage");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->errmessage, PyBytes_AS_STRING(encoded_field));
...
PyObject * my_robot_interfaces__msg__hardware_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // temparature
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->temparature);
    {
      int rc = PyObject_SetAttrString(_pymessage, "temparature", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // motorstatus
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->motorstatus ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "motorstatus", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // errmessage
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->errmessage.data,
      strlen(ros_message->errmessage.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "errmessage", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
