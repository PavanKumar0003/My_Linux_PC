...
class HardwareStatus(metaclass=Metaclass_HardwareStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.temparature = kwargs.get('temparature', int())
        self.motorstatus = kwargs.get('motorstatus', bool())
        self.errmessage = kwargs.get('errmessage', str())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.temparature != other.temparature:
            return False
        if self.motorstatus != other.motorstatus:
            return False
        if self.errmessage != other.errmessage:
            return False
        return True
    ...
    def temparature(self, value):
        if __debug__:
            assert \
                ...
                "The 'temparature' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'temparature' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._temparature = value

    @builtins.property
    def motorstatus(self):
        """Message field 'motorstatus'."""
        return self._motorstatus

    @motorstatus.setter
    def motorstatus(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'motorstatus' field must be of type 'bool'"
        self._motorstatus = value
    ...
    @errmessage.setter
    def errmessage(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'errmessage' field must be of type 'str'"
        self._errmessage = value
