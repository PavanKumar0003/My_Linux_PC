...
#include "rosidl_runtime_c/string.h"  // errmessage
#include "rosidl_runtime_c/string_functions.h"  // errmessage
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message->temparature;
  }

  // Field name: motorstatus
  {
    cdr << (ros_message->motorstatus ? true : false);
  }

  // Field name: errmessage
  {
    const rosidl_runtime_c__String * str = &ros_message->errmessage;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: motorstatus
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->motorstatus = tmp ? true : false;
  }
  ...
  // Field name: errmessage
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->errmessage.data) {
      rosidl_runtime_c__String__init(&ros_message->errmessage);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->errmessage,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'errmessage'\n");
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name temparature
  {
    size_t item_size = sizeof(ros_message->temparature);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name motorstatus
  {
    size_t item_size = sizeof(ros_message->motorstatus);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name errmessage
