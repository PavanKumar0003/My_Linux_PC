...
my_robot_interfaces__msg__HardwareStatus__init(my_robot_interfaces__msg__HardwareStatus * msg)
{
  ...
  // motorstatus
  // errmessage
  if (!rosidl_runtime_c__String__init(&msg->errmessage)) {
...
my_robot_interfaces__msg__HardwareStatus__fini(my_robot_interfaces__msg__HardwareStatus * msg)
{
  ...
  // motorstatus
  // errmessage
  rosidl_runtime_c__String__fini(&msg->errmessage);
}
...
my_robot_interfaces__msg__HardwareStatus__are_equal(const my_robot_interfaces__msg__HardwareStatus * lhs, const my_robot_interfaces__msg__HardwareStatus * rhs)
{
  ...
  // temparature
  if (lhs->temparature != rhs->temparature) {
    return false;
  }
  // motorstatus
  if (lhs->motorstatus != rhs->motorstatus) {
    return false;
  }
  // errmessage
  if (!rosidl_runtime_c__String__are_equal(
      &(lhs->errmessage), &(rhs->errmessage)))
  {
    return false;
  }
  return true;
  ...
  my_robot_interfaces__msg__HardwareStatus * output)
{
  ...
  // temparature
  output->temparature = input->temparature;
  // motorstatus
  output->motorstatus = input->motorstatus;
  // errmessage
  if (!rosidl_runtime_c__String__copy(
      &(input->errmessage), &(output->errmessage)))
  {
    return false;
  }
  return true;
