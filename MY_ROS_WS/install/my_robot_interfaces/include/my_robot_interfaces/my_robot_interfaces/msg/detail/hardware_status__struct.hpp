...
struct HardwareStatus_
{
  ...
  using _temparature_type =
    int64_t;
  _temparature_type temparature;
  using _motorstatus_type =
    bool;
  _motorstatus_type motorstatus;
  using _errmessage_type =
    std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>;
  _errmessage_type errmessage;

  // setters for named parameter idiom
  Type & set__temparature(
    const int64_t & _arg)
  {
    this->temparature = _arg;
    return *this;
  }
  Type & set__motorstatus(
    const bool & _arg)
  {
    this->motorstatus = _arg;
    return *this;
  }
  Type & set__errmessage(
    const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> & _arg)
  {
    this->errmessage = _arg;
    return *this;
  }
  ...
  {
    if (this->temparature != other.temparature) {
      return false;
    }
    if (this->motorstatus != other.motorstatus) {
      return false;
    }
    if (this->errmessage != other.errmessage) {
      return false;
    }
    return true;
  }
